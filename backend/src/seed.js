...
const seed = async () => {
    try {
        ...
        const c3 = await Category.create({ name: 'Memória RAM', slug: 'memoria-ram' });
        const c4 = await Category.create({ name: 'Armazenamento', slug: 'armazenamento' });
        const c5 = await Category.create({ name: 'Periféricos', slug: 'perifericos' });
