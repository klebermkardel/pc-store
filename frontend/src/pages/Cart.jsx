        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-3">
            {cart.map(item => (
              <div
                key={item.id}
                className="group bg-[#0d1117] border border-white/5 hover:border-emerald-500/20 flex gap-4 p-4 transition-all duration-300 relative overflow-hidden"
              >
                ...
                {/* Imagem */}
                <Link to={`/product/${item.id}`} className="shrink-0 w-20 h-20 bg-[#111620] overflow-hidden block">
                  <img
                    src={item.image_url}
                    alt={item.name}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-3">
                    ...
                    <button
                      ...
                      className="text-gray-700 hover:text-red-400 font-mono text-[9px] tracking-widest uppercase transition-colors duration-200 ml-2"
                    >
                      remover
                    </button>
                  </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-[#0d1117] border border-white/5 relative overflow-hidden sticky top-24">
