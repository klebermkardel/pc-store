    ...
    <div className="flex items-center gap-0 mb-10">
      {STEPS.map((step, i) => (
        <div key={step} className="flex items-center">
          ...
          {i < STEPS.length - 1 && (
            <div className={`w-20 h-[1px] mb-4 mx-1 transition-all duration-500 ${
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-3">
        {metodos.map(m => (
          <button
            ...
            className={`flex flex-col items-center gap-2 py-4 border font-mono text-xs tracking-widest uppercase transition-all duration-200 ${
              form.pagamento === m.id
                ? 'bg-emerald-500/10 border-emerald-500 text-emerald-400'
      ...
      {form.pagamento === 'pix' && (
        <div className="bg-[#0d1117] border border-white/5 p-6 flex flex-col items-center gap-4">
          ...
          <div className="w-32 h-32 border border-emerald-500/20 flex items-center justify-center">
      ...
      {form.pagamento === 'boleto' && (
        <div className="bg-[#0d1117] border border-white/5 p-6 space-y-3">
          ...
          <div className="border border-white/10 px-4 py-3 font-mono text-xs text-gray-600 tracking-widest">
        ...
        <div className="p-5 grid grid-cols-2 gap-3">
          {[
            ...
            <div key={label}>
              ...
              <p className="text-gray-300 text-xs font-mono">{value || '—'}</p>
            </div>
          ))}
        </div>
      </div>
...
function Sucesso({ nome, onVoltar }) {
  return (
    <div className="min-h-screen bg-[#080b0f] flex flex-col items-center justify-center gap-4 text-center px-6">
      <div className="w-16 h-16 border border-emerald-500/40 bg-emerald-500/10 flex items-center justify-center mb-2">
      ...
      <button
        onClick={onVoltar}
        className="mt-6 px-8 py-3 bg-emerald-500/10 border border-emerald-500/25 hover:bg-emerald-500/20 hover:border-emerald-500 text-emerald-400 font-mono text-xs tracking-widest uppercase transition-all duration-200"
      >
        Voltar à loja
      </button>
    </div>
...
function Checkout() {
  ...
  if (concluido) return <Sucesso nome={form.nome} onVoltar={handleVoltar} />;

  if (cart.length === 0) return (
    <div className="min-h-screen bg-[#080b0f] flex flex-col items-center justify-center gap-4">
        ...
        <div className="flex gap-3">
          {step > 0 && (
            <button
              ...
              className="px-6 py-3 bg-white/[0.02] border border-white/[0.06] hover:border-white/20 text-gray-600 hover:text-gray-400 font-mono text-xs tracking-widest uppercase transition-all duration-200"
            >
              ← Voltar
            </button>
          )}
