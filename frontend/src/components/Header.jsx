                    ...
                    <ul className="flex items-center gap-6">
                        ...
                        {user ? (
                            <li className="relative">
                                ...
                                >
                                    <div className="w-8 h-8 rounded-full border border-white/10 group-hover:border-emerald-500/40 bg-white/[0.02] group-hover:bg-emerald-500/10 flex items-center justify-center transition-all duration-200 overflow-hidden">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-gray-500 group-hover:text-emerald-400 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                ...
                                {/* Dropdown */}
                                {showDropdown && (
                                    <div className="absolute right-0 top-11 w-48 bg-[#0d1117] border border-white/10 z-50 overflow-hidden">
                                        ...
                                        {user.is_admin && (
                                            <Link
                                                ...
                                                className="flex items-center gap-2 px-4 py-2 text-emerald-500/70 hover:text-emerald-400 hover:bg-white/[0.02] font-mono text-[10px] tracking-wider uppercase transition-all duration-200"
                                            >
                                                ▣ Painel Admin
                                            </Link>
                                        )}
                                        <button
                                            ...
                                            className="w-full text-left flex items-center gap-2 px-4 py-2 text-gray-600 hover:text-red-400 hover:bg-white/[0.02] font-mono text-[10px] tracking-wider uppercase transition-all duration-200"
                                        >
                                            ← Sair
                                        </button>
                                    </div>
