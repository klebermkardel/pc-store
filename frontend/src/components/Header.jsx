            ...
            <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <nav>
                    <ul className="flex items-center gap-6">
                        <li>
                            <Link to="/" className="text-gray-500 hover:text-emerald-400 font-mono text-xs tracking-widest uppercase transition-colors duration-200">
                                Home
                            </Link>
                        </li>
                        ...
                        {user ? (
                            <>
                                <li className="flex items-center gap-2">
                                    ...
                                    <span className="text-gray-400 font-mono text-xs tracking-widest truncate max-w-[120px]">
                                        {user.name.split(' ')[0]}
                                    </span>
                                </li>
                                <li>
                                    <button
                                        ...
                                        className="text-gray-600 hover:text-red-400 font-mono text-xs tracking-widest uppercase transition-colors duration-200"
                                    >
                                        Sair
                                    </button>
                                </li>
                            ...
                            <li>
                                <Link to="/login" className="text-gray-500 hover:text-emerald-400 font-mono text-xs tracking-widest uppercase transition-colors duration-200">
                                    Login
                                </Link>
                            </li>
                        )}
